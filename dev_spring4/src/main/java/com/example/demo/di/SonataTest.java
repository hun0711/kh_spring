 ...
 * :역제어란 객체의 생성 및 생명 주기에 대한 제어권이 개발자에서 Container에게 넘어갔다는 것을 의미함
 * 기존 방식
 * 자바 기반으로 어플리케이션을 개발 할 때 자바 객체를 생성하고 서로간의 의존관계를
 ...
 * 
 * IoC사용시
 * 제어권이 Container에게 넘어가 객체의 생명 주기를 Container가 전담하게 됨   예)서블릿,EJB
 ...
 * : spring-bean.jar에 속함
 * : Bean들에 대한 생성, 소멸, Life Cycle과 같은
 ...
 * -> 어플리케이션 동작시 Bean 생성을 기다리지 않아도 됨
 * 
 * 
 * 
 * 
